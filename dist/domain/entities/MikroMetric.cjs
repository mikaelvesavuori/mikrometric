...
var MikroMetric_exports = {};
__export(MikroMetric_exports, {
  MikroMetric: () => MikroMetric
});
module.exports = __toCommonJS(MikroMetric_exports);
var import_crypto = require("crypto");
var import_aws_metadata_utils = require("aws-metadata-utils");
...
var MikroMetric = class _MikroMetric {
  ...
  createDynamicMetadata() {
    const metadata = (0, import_aws_metadata_utils.getMetadata)(_MikroMetric.event, _MikroMetric.context);
